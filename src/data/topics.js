...
export const categories = [
  ...
  },
  {
    key: 'mba',
    label: 'MBA Skills',
    description: 'Business, strategy, and management fundamentals.',
    docsHref: '/docs/category/mba-skills',
  },
];
...
export const topics = [
  ...
  {id: 'playwright-cross-browser-testing', title: 'Cross-Browser Testing', emoji: '🎭', href: '/cheatsheets/playwright-cross-browser-testing', category: 'sdet'},
  ...
  {id: 'sre-observability-slos', title: 'SLOs & Observability', emoji: '📡', href: '/cheatsheets/sre-observability-slos', category: 'sre'},
  ...
  // MBA Skills
  {id: 'leadership-for-sdet-managers', title: 'Leadership for SDET Managers', emoji: '👔', href: '/cheatsheets/leadership-for-sdet-managers', category: 'mba'},
  {id: 'manager-response-library', title: 'Manager Response Library', emoji: '💬', href: '/cheatsheets/manager-response-library', category: 'mba'},
  {id: 'quality-engineering-leadership-playbook', title: 'QE Leadership Playbook', emoji: '🧭', href: '/cheatsheets/quality-engineering-leadership-playbook', category: 'mba'},
  {id: 'team-organizational-leadership', title: 'Team & Org Leadership', emoji: '🤝', href: '/cheatsheets/team-organizational-leadership', category: 'mba'},
  {id: 'executive-communication-influence', title: 'Executive Communication', emoji: '🎤', href: '/cheatsheets/executive-communication-influence', category: 'mba'},
  {id: 'engineering-governance-operations', title: 'Engineering Governance', emoji: '🏢', href: '/cheatsheets/engineering-governance-operations', category: 'mba'},
  {id: 'business-analytics-strategic-consulting', title: 'Business Analytics & Consulting', emoji: '📈', href: '/cheatsheets/business-analytics-strategic-consulting', category: 'mba'},
  {id: 'technical-product-management-product-strategy', title: 'Product Management & Strategy', emoji: '🎯', href: '/cheatsheets/technical-product-management-product-strategy', category: 'mba'},
];
