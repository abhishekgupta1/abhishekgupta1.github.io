...
const TIERS = {
  ...
  mba: {
    beginner: ['leadership-for-sdet-managers', 'manager-response-library'],
    intermediate: ['team-organizational-leadership', 'executive-communication-influence', 'technical-product-management-product-strategy'],
    advanced: ['quality-engineering-leadership-playbook', 'engineering-governance-operations', 'business-analytics-strategic-consulting'],
  },
};
